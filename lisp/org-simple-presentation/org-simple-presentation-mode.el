...
(defvar org-simple-presentation-mode-map (make-keymap))
...
(define-key org-simple-presentation-mode-map (kbd "\C-c s") 'org-simple-presentation-start)
(define-key org-simple-presentation-mode-map (kbd "\C-c e") 'org-simple-presentation-end)
(define-key org-simple-presentation-mode-map (kbd "\C-c n") 'org-simple-presentation-goto-next)
(define-key org-simple-presentation-mode-map (kbd "\C-c p") 'org-simple-presentation-goto-previous)
